...
- [Post-Release Evidence Ledger](examples/support/post-release-evidence-ledger.md)
...
After npm publish, use the [release support provenance gate](examples/support/release-support-provenance.md) to record the registry version, GitHub Release URL, installed-package verification command, package-relative support artifacts, repo-only path exclusions, and privacy scan result. Then use the [post-release evidence ledger](examples/support/post-release-evidence-ledger.md) to capture CI/release/publish workflow statuses, public `npx` smokes, installed-package provenance result, tarball file count, and private-ish path exclusion summary. The installed-package verification command is:
